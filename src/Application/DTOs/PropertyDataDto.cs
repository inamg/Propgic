...
public class PropertyDataDto
{
    ...
    // 2. Land ownership (5%)
    public string? LandOwnership { get; set; } // Freehold, Leasehold, Strata
    ...
    // 4. Zoning (4%)
    public string? Zoning { get; set; } // Residential, Commercial, Mixed

    // 5. Location category (5%)
    public string? LocationCategory { get; set; } // Metro, Regional, Rural

    // 6. Proximity to CBD (3%)
    public int? DistanceToCbdKm { get; set; }

    // 7. School zone quality (4%)
    public string? SchoolZoneQuality { get; set; } // Top-tier, Good, Average
    ...
    public string? LocalDemand { get; set; } // High, Medium, Low
    ...
    public string? MaintenanceLevel { get; set; } // Minimal, Moderate, Extensive
