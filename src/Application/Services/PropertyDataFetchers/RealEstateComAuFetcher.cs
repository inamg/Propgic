...
public class RealEstateComAuFetcher : IPropertyDataFetcher
{
    ...
    public RealEstateComAuFetcher(ChatGptUrlDiscoveryService chatGptService)
    {
    ...
    private static string? ExtractAddressFromUrl(string url)
    {
        try
        {
            ...
            // RealEstate.com.au URLs typically look like: /property-123-example-street-suburb-state-1234567
